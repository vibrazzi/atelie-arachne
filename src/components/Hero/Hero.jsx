...
import Image1 from "../../assets/hero/collection.png";
...
const Hero = () => {
  ...
  return (
    <div className="flex justify-center relative overflow-hidden min-h-[550px] sm:min-h-[650px] text-light duration-200 w-full">
      <div className="h-[700px] w-[700px] absolute -top-1/2 right-0 rounded-3xl rotate-45 -z-[8]"></div>
      <div className="container px-2 sm:px-8 bg-gradient-to-br from-[#F5F5F5] via-white to-[#F5F5F5]/80 rounded-2xl w-full mx-4 sm:mx-10">
        <Slider {...settings}>
          {ImageList.map((data) => (
            <div key={data.id}>
                ...
                <div className="order-1 sm:order-2">
                  ...
                  >
                    <img
                      src={data.img}
                      alt=""
                      className="w-[250px] h-[250px] sm:h-[400px] sm:w-[400px] lg:h-[450px] lg:w-[450px] object-contain mx-auto py-5"
                    />
                  </div>
                </div>
              </div>
